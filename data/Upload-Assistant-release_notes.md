...
## RELEASE NOTES
 ...
 - I've defaulted to localhost only, and added some basic auth, but users should ensure that their network is properly protected if exposing to the web. See updated docs https://github.com/Audionut/Upload-Assistant/tree/master/docs
