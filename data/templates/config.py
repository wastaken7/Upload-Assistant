...
config = {
    "DEFAULT": {
        ...
        # Available image hosts: imgbb, imgbox, pixhost, lensdump, ptscreens, oeimg, dalexni, zipline, passtheimage, seedpool_cdn, sharex, utppm, lostimg
        "img_host_1": "imgbb",
        "img_host_2": "imgbox",
        ...
        # Set to None or remove to disable this feature.
