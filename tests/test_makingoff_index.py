...
def test_index_parser_keeps_only_the_exact_imdb_match():
    ...
    <div class="filme-card">
      <h4 class="card-title"><a href="/topicos/73517/">Filme Imaginário</a></h4>
      <a href="?ano=1951">1951</a>
      <a href="https://www.imdb.com/title/tt1234567">Página Oficial</a>
    </div>
    <div class="filme-card">
    ...
    assert MakingOff._parse_index_results(html, "tt1234567") == {  # noqa: S101
        "Filme Imaginário (1951)": "https://www.makingoff.org/topicos/73517/"
    }
