...
class Args():
    ...
    def parse(self, args, meta):
        ...
        parser.add_argument('-oil', '--only-if-languages', dest='has_languages',  nargs=1, required=False, help="Require at least one of the languages to upload. Comma separated list e.g. 'English, French, Spanish'", type=str)
