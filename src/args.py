...
class Args():
    ...
    def parse(self, args, meta):
        ...
        parser.add_argument('-c', '--category', nargs=1, required=False, help="Category [movie, tv, fanres, reading]", choices=['movie', 'tv', 'fanres', 'reading'], dest="manual_category")
        parser.add_argument('-isbn', '--isbn', nargs=1, required=False, help="ISBN for books", type=str)
