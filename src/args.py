...
class Args():
    ...
    def parse(self, args, meta):
        ...
        parser.add_argument('-imdb', '--imdb', nargs='*', required=False, help="IMDb ID", type=str, dest='imdb_manual')
        parser.add_argument('-mal', '--mal', nargs='*', required=False, help="MAL ID", type=str, dest='mal_manual')
