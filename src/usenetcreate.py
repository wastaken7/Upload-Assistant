            ...
            while True:
                ...
                try:
                    ...
                    if etype == "segment_done":
                        ...
                        logger.info(f"[yellow]Article check: round {round_num}/{max_rounds} — {missing} article(s) missing, reposting automatically...[/yellow]")
                        ...
                        if still_missing:
                            logger.info(f"[yellow]Article check: round {round_num}/{max_rounds} — reposted {reposted} article(s), {still_missing} still missing[/yellow]")
