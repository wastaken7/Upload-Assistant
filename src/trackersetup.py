...
tracker_class_map = {
    ...
    'LST': LST, 'LT': LT, 'MTV': MTV, 'NBL': NBL, 'OE': OE, 'OTW': OTW, 'PSS': PSS, 'PTT': PTT, 'PTP': PTP, 'PTER': PTER,
...
api_trackers = {
    ...
    'OE', 'OTW', 'PSS', 'PTT', 'RAS', 'RF', 'R4E', 'SAM', 'SHRI', 'SP', 'STC', 'TIK', 'TOCA', 'UHD', 'ULCX', 'UTP', 'YOINK', 'YUS'
}
