    ...
    async def upload(self, meta, disctype):
        ...
        if meta['debug'] is False:
            ...
            try:
                ...
                await common.add_tracker_torrent(meta, self.tracker, self.source_flag, self.config['TRACKERS'][self.tracker].get('announce_url'), "https://polishtorrent.top/torrents/" + t_id, headers=headers, params=params, downurl=response.json()['data'])
            except Exception:
