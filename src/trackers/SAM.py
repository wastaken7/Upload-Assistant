...
class SAM():
    def __init__(self, config):
        ...
        self.upload_url = 'https://samaritano.cc/api/torrents/upload'
        self.search_url = 'https://samaritano.cc/api/torrents/filter'
        self.torrent_url = 'https://samaritano.cc/torrents/'
