...
class TVC():
    ...
    async def upload(self, meta, disctype):
        ...
        if 'upload_to_tvc' in locals() and upload_to_tvc == False:
            return
    ...
    async def get_tmdb_data(self, meta):
       ...
       if 'origin_country' in response:
           if type(response['origin_country']) == list:
    ...
    async def search_existing(self, meta, disctype):
        ...
        console.print("[RED]Search API has been disabled. This will fail and thats normal...")
