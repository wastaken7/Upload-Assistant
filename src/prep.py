...
class Prep():
    ...
    async def gather_prep(self, meta, mode):
        ...
        if meta.get('tag') == "-SubsPlease":  # SubsPlease-specific, applicable to 1080p only
            ...
            meta['episode_title'] = ""
            if (bitrate.isdigit() and int(bitrate) >= 8000000) or (bitrate_oldMediaInfo.isdigit() and int(bitrate_oldMediaInfo) >= 8000000) and meta.get('resolution') == "1080p":
                meta['service'] = "CR"
                ...
                meta['service'] = "HIDI"
            elif (bitrate.isdigit() and int(bitrate) >= 4000000) or (bitrate_oldMediaInfo.isdigit() and int(bitrate_oldMediaInfo) >= 4000000) and meta.get('resolution') == "720p":
                meta['service'] = "CR"
