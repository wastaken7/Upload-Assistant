...
if [ "$(id -u)" = "0" ]; then
    ...
    for dir in /Upload-Assistant/data /Upload-Assistant/tmp /Upload-Assistant/session_secret /root/.config/upload-assistant /Upload-Assistant/bin/MI /Upload-Assistant/bin/dovi_tool /Upload-Assistant/bin/hdr10plus_tool; do
